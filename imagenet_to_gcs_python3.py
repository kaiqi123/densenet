...
flags.DEFINE_string('raw_data_dir', None, 'Directory path for raw Imagenet dataset. ''Should have train and validation subdirectories inside it.')
flags.DEFINE_string('imagenet_username', None, 'Username for Imagenet.org account')
flags.DEFINE_string('imagenet_access_key', None, 'Access Key for Imagenet.org account')
flags.DEFINE_boolean('gcs_upload', False, 'Set to false to not upload to gcs.')
...
def _is_cmyk(filename):
  ...
  # File list from:
  # https://github.com/cytsai/ilsvrc-cmyk-image-list
  blacklist = set([b'n01739381_1309.JPEG', b'n02077923_14822.JPEG',
                   b'n02447366_23489.JPEG', b'n02492035_15739.JPEG',
                   b'n02747177_10752.JPEG', b'n03018349_4028.JPEG',
                   b'n03062245_4620.JPEG', b'n03347037_9675.JPEG',
                   b'n03467068_12171.JPEG', b'n03529860_11437.JPEG',
                   b'n03544143_17228.JPEG', b'n03633091_5218.JPEG',
                   b'n03710637_5125.JPEG', b'n03961711_5286.JPEG',
                   b'n04033995_2932.JPEG', b'n04258138_17003.JPEG',
                   b'n04264628_27969.JPEG', b'n04336792_7448.JPEG',
                   b'n04371774_5854.JPEG', b'n04596742_4225.JPEG',
                   b'n07583066_647.JPEG', b'n13037406_4650.JPEG'])
